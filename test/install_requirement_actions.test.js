...
import { buildInstallRequirementActions, normalizeInstallRequirementActions } from '../src/shared/install_requirement_actions.js';
...
test('buildInstallRequirementActions derives tool, credential, and generated skill actions', () => {
  ...
  assert.equal(actions.tool_install_proposals[0].strategy, 'enable_workspace_fs');
