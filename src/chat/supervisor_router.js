...
function buildRouterPrompt(message, context = {}) {
  ...
  return [
    ...
    "    {\"type\":\"spawn_agents\",\"summary\":\"...\",\"lens\":{\"mode\":\"shared_only|unfold_query|add_nodes|remove_nodes\"},\"agents\":[{\"agent_id\":\"...\",\"goal\":\"...\",\"lens\":{\"mode\":\"shared_only|unfold_query|add_nodes|remove_nodes\"},\"risk\":\"L1\"}],\"max_parallel\":2},",
