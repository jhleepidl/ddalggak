...
const PROVIDER_ENV_KEYS = [
  ...
  'DDALGGAK_CODEX_SKIP_GIT_REPO_CHECK',
  'DDALGGAK_CODEX_SKIP_GIT_REPO_CHECK_ROOT',
  ...
  'ROOM_EXECUTION_ENGINE',
  'ROOM_RUNTIME_ROOT',
  'ROOM_WORKSPACES_ROOT',
  'ROOM_STATE_ROOT',
  'ROOM_DEFAULT_PROGRESS_VISIBILITY',
  'ROOM_NATIVE_PRIMARY_USER_PATH',
  'ROOM_DEFAULT_COLLABORATION_PROFILE',
  'ROOM_RESUME_ALLOW_WORKSPACE_DRIFT',
  'ROOM_AGENT_TIMEOUT_MS',
  'ROOM_PROVIDER_BWRAP_SMOKE_TIMEOUT_MS',
  'ROOM_STAGE_MAX_ATTEMPTS',
  'ROOM_REVIEW_MAX_ROUNDS',
  'ROOM_STAGE_RETRY_DELAY_MS',
  'ROOM_STAGE_PROGRESS_MAX_EVENTS',
  'ROOM_WORKSPACE_MAX_SCAN_ENTRIES',
  'ROOM_WORKSPACE_MANIFEST_MAX_ENTRIES',
  'ROOM_WORKSPACE_MANIFEST_MAX_HASH_BYTES',
  'ROOM_ALLOW_RUNTIME_INSIDE_CONTROL_ROOT',
  'ROOM_PROVIDER_OS_SANDBOX',
  'ROOM_PROVIDER_BWRAP_COMMAND',
  'ROOM_PROVIDER_BWRAP_WRITABLE_DIRS',
  'ROOM_PROVIDER_CHILD_ENV_ALLOWLIST',
  'DDALGGAK_CONTROL_ROOT',
];
...
const ENUM_ENV_KEYS = {
  ...
  ROOM_EXECUTION_ENGINE: ['legacy', 'room_native', 'room_native_v2', 'v2'],
  ROOM_DEFAULT_PROGRESS_VISIBILITY: ['quiet', 'standard', 'debug'],
  ROOM_DEFAULT_COLLABORATION_PROFILE: ['solo', 'builder_reviewer', 'research_then_execute', 'parallel_ideation', 'review_loop', 'deliberate', 'iterative_project'],
