...
const PROJECT_ENV_PREFIXES = [
  ...
  'GOOGLE_AI_', 'GEMINI_', 'OPENAI_COMPATIBLE_', 'LOCAL_MODEL_', 'OLLAMA_', 'LLM_TRACE_', 'CHAT_', 'ROOM_MEMORY_TRIALS_',
];
...
const ENUM_ENV_KEYS = {
  ...
  DDALGGAK_FAST_PROVIDER: ['auto', 'antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
  DDALGGAK_SEARCH_PROVIDER: ['auto', 'antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
  DDALGGAK_WORK_PROVIDER: ['auto', 'antigravity', 'openai_compatible', 'codex', 'none', 'disabled', 'workbench'],
  DDALGGAK_DIRECT_ASK_PROVIDER: ['auto', 'antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
  ROOM_CONCIERGE_DIRECT_ASK_PROVIDER: ['auto', 'antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
  DDALGGAK_SEARCH_ASK_PROVIDER: ['auto', 'antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
  ROOM_CONCIERGE_SEARCH_ASK_PROVIDER: ['auto', 'antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
  DDALGGAK_GEMINI_REPLACEMENT_PROVIDER: ['antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
  GEMINI_REPLACEMENT_PROVIDER: ['antigravity', 'openai_compatible', 'codex', 'none', 'disabled'],
...
const CANONICAL_LEGACY_CONFLICTS = [
  ...
  { canonical: 'DDALGGAK_FAST_TIMEOUT_MS', legacy: ['DDALGGAK_DIRECT_ASK_TIMEOUT_MS', 'ANTIGRAVITY_TIMEOUT_MS'] },
  { canonical: 'DDALGGAK_SEARCH_TIMEOUT_MS', legacy: ['DDALGGAK_SEARCH_ASK_TIMEOUT_MS', 'ANTIGRAVITY_TIMEOUT_MS'] },
...
export function auditDdalggakRuntimeEnv({ env = process.env, configuredKeys = null, sourceLabel = 'process.env' } = {}) {
  ...
  const warnings = [];
  const info = [];
  const unknown = configuredProjectKeys.filter((key) => !KNOWN_RUNTIME_ENV_KEYS.has(key));
