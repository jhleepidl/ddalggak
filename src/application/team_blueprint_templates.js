...
const TEMPLATE_DEFS = {
  ...
  iterative_improvement: {
    ...
    agents: [
      ...
      { agent_id: 'repo_scout', name: 'Repo Scout', role: 'researcher', purpose: 'Inspect the repository, surface constraints, and suggest competing implementation options.', runtime_capabilities_required: ['filesystem_read'], runtime_capabilities_optional: ['web_browse'], model: 'gemini-3-flash-preview', provider: 'gemini' },
